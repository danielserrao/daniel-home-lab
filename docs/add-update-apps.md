...
When wanting to create a new reusable application, we are using [Kustomize](https://kubectl.docs.kubernetes.io/guides/introduction/kustomize/) and also frequently [Helm](https://helm.sh/docs).
